...
class CrownAnalyser: 
    def __init__(self): 
        self.kmeans = joblib.load("Program_AD\models\kmeans_model.joblib")
        self.svm_sift = joblib.load("Program_AD\models\SVM_SIFT_finde_kroner.joblib")
        self.scaler = joblib.load("Program_AD\models\SVM_SIFT_finde_kroner_scaler.joblib")
